...
def main_window():
    ...
    tk.Button(main, text="Reportes", command=print, height=2,width=20).place(x=340, y=170)
    tk.Button(main, text="Graficos", command=print, height=2,width=20).place(x=168, y=240)
    tk.Button(main, text="Salir ", command=lambda:[files.file_activities(st),close(main)], height=2,width=20).place(x=340, y=240)
